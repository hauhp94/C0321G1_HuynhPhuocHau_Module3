...
public class Contract {
    ...
    public Contract(int contract_id, String contract_start_date, String contract_end_date, double contract_deposit,
                    double contract_total_money, int employee_id, String employee_name, int customer_id,
                    String customer_name, int service_id, String service_name) {
    ...
    public String toString() {
        return "Contract{" +
                ...
                ", contract_total_money=" + contract_total_money +
