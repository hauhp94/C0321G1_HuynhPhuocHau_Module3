...
public class UserServlet extends HttpServlet {
    ...
    private void showSortByName(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        List<User> listUser = service.selectAllUsersSortByName();
    ...
    private void showUserByCountry(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<User> listUser = service.selectUserByCountry(country);
        request.setAttribute("listUser", listUser);
        RequestDispatcher dispatcher = request.getRequestDispatcher("user/list.jsp");
        dispatcher.forward(request, response);
    }
